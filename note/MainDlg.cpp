...
LRESULT CMainDlg::OnInitDialog(UINT /*uMsg*/, WPARAM /*wParam*/, LPARAM /*lParam*/, BOOL& /*bHandled*/)
{
	...
	GetPrivateProfileStructW(L"Color", L"TextSelBkColor", (LPVOID)&clTextSelBkColor, sizeof(COLORREF), SaveIniFilePath() + M_INI_PATH);
	GetPrivateProfileStructW(L"Color", L"TextSelFrColor", (LPVOID)&clTextSelFrColor, sizeof(COLORREF), SaveIniFilePath() + M_INI_PATH);
	GetPrivateProfileStructW(L"Color", L"EditBkColor", (LPVOID)&clEditBkColor, sizeof(COLORREF), SaveIniFilePath() + M_INI_PATH);
	GetPrivateProfileStructW(L"Color", L"TextFrColor", (LPVOID)&clTextFrColor, sizeof(COLORREF), SaveIniFilePath() + M_INI_PATH);
	GetPrivateProfileStructW(L"Color", L"CurLineBkColor", (LPVOID)&clCurLineBkColor, sizeof(COLORREF), SaveIniFilePath() + M_INI_PATH);
	GetPrivateProfileStructW(L"Color", L"MuiltiTextFrColor", (LPVOID)&clMuiltiTextFrColor, sizeof(COLORREF), SaveIniFilePath() + M_INI_PATH);
	GetPrivateProfileStructW(L"Color", L"MuiltiTextBkColor", (LPVOID)&clMuiltiTextBkColor, sizeof(COLORREF), SaveIniFilePath() + M_INI_PATH);
	GetPrivateProfileStructW(L"Color", L"CurColor", (LPVOID)&clCurColor, sizeof(COLORREF), SaveIniFilePath() + M_INI_PATH);
	GetPrivateProfileStructW(L"Color", L"MultiCurColor", (LPVOID)&clMultiCurColor, sizeof(COLORREF), SaveIniFilePath() + M_INI_PATH);
	
	m_sciEdit.SetSelBack(TRUE, clTextSelBkColor);
	m_sciEdit.SetSelFore(TRUE, clTextSelFrColor);
	m_sciEdit.StyleSetBack(STYLE_DEFAULT, clEditBkColor);
	m_sciEdit.StyleSetBack(0, clEditBkColor);
	m_sciEdit.StyleSetFore(0, clTextFrColor);
	m_sciEdit.SetCaretLineBack(clCurLineBkColor);
	m_sciEdit.SetAdditionalSelFore(clMuiltiTextFrColor);
	m_sciEdit.SetAdditionalSelBack(clMuiltiTextBkColor);
	m_sciEdit.SetCaretFore(clCurColor);
	m_sciEdit.SetAdditionalCaretFore(clMultiCurColor);
	m_sciEdit.SetSelAlpha(125);

	BOOL bWrapLine = GetPrivateProfileInt(TEXT("WrapMode"), TEXT("wrap_line"), 0, SaveIniFilePath() + M_INI_PATH);
	m_sciEdit.SetWrapMode(bWrapLine);   
	m_sciEdit.SetVScrollBar(bWrapLine);
	m_sciEdit.SetHScrollBar(TRUE);   // wrapline ? show : hide
	m_sciEdit.SetMarginWidthN(TRUE, 0);
	m_sciEdit.SetCaretLineVisibleAlways(TRUE);
	m_sciEdit.SetCaretLineVisible(TRUE);
	m_sciEdit.SetMultipleSelection(TRUE);
	m_sciEdit.SetAdditionalSelectionTyping(TRUE);   //  允许修改被选中（多选）的文本
...
LRESULT CMainDlg::OnDestroy(UINT /*uMsg*/, WPARAM /*wParam*/, LPARAM /*lParam*/, BOOL& /*bHandled*/)
{
	...
	WritePrivateProfileStructW(L"Font", L"edit font", (LPVOID)&m_lfont, sizeof(m_lfont), SaveIniFilePath() + M_INI_PATH);


	COLORREF
		clTextSelBkColor = m_sciEdit.GetSelBack(),
		clTextSelFrColor = m_sciEdit.GetSelFore(),
		clEditBkColor = m_sciEdit.StyleGetBack(STYLE_DEFAULT),
		clTextFrColor = m_sciEdit.StyleGetFore(STYLE_DEFAULT),
		clCurLineBkColor = m_sciEdit.GetCaretLineBack(),
		clMuiltiTextFrColor = m_sciEdit.GetSelFore(),
		clMuiltiTextBkColor = m_sciEdit.GetSelBack(),
		clCurColor = m_sciEdit.GetCaretFore(),
		clMultiCurColor = m_sciEdit.GetAdditionalCaretFore();


	WritePrivateProfileStructW(L"Color", L"TextSelBkColor", (LPVOID)&clTextSelBkColor, sizeof(COLORREF), SaveIniFilePath() + M_INI_PATH);
	WritePrivateProfileStructW(L"Color", L"TextSelFrColor", (LPVOID)&clTextSelFrColor, sizeof(COLORREF), SaveIniFilePath() + M_INI_PATH);
	WritePrivateProfileStructW(L"Color", L"EditBkColor", (LPVOID)&clEditBkColor, sizeof(COLORREF), SaveIniFilePath() + M_INI_PATH);
	WritePrivateProfileStructW(L"Color", L"TextFrColor", (LPVOID)&clTextFrColor, sizeof(COLORREF), SaveIniFilePath() + M_INI_PATH);
	WritePrivateProfileStructW(L"Color", L"CurLineBkColor", (LPVOID)&clCurLineBkColor, sizeof(COLORREF), SaveIniFilePath() + M_INI_PATH);
	WritePrivateProfileStructW(L"Color", L"MuiltiTextFrColor", (LPVOID)&clMuiltiTextFrColor, sizeof(COLORREF), SaveIniFilePath() + M_INI_PATH);
	WritePrivateProfileStructW(L"Color", L"MuiltiTextBkColor", (LPVOID)&clMuiltiTextBkColor, sizeof(COLORREF), SaveIniFilePath() + M_INI_PATH);
	WritePrivateProfileStructW(L"Color", L"CurColor", (LPVOID)&clCurColor, sizeof(COLORREF), SaveIniFilePath() + M_INI_PATH);
	WritePrivateProfileStructW(L"Color", L"MultiCurColor", (LPVOID)&clMultiCurColor, sizeof(COLORREF), SaveIniFilePath() + M_INI_PATH);
...
void CMainDlg::SetFontInfo(LOGFONT & lf)
{
	...
	m_sciEdit.StyleSetUnderline(0, lf.lfUnderline);
}
